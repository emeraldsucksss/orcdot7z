...
game:GetService("ScriptInformationProvider"):SetAssetUrl("http://www.yoursite.local/asset/")
...
game:GetService("InsertService"):SetAssetUrl("http://yoursite.local/asset/?id=%d")
